...
class ColorHighlight_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function footer() {
        ...
        echo '<script type="text/javascript" src="'. $jsUrl .'res/clipboard.min.js"></script>
		      <script type="text/javascript" src="'. $jsUrl .'res/highlight.js?version=9.12.0"></script>
		      <script type="text/javascript" src="'. $jsUrl .'guess.js"></script>';
    /*XenWayne:调整了clipboard.min.js与guess.js的加载顺序，防止"Uncaught ReferenceError: Clipboard is not defined"*/
